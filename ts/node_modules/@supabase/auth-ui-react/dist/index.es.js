...
import e, { useState as h, useRef as s1, useEffect as U, createContext as c1, useContext as i1 } from "react";
const a1 = F({
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...o,
      style: (t = l == null ? void 0 : l.style) == null ? void 0 : t.anchor,
      className: s.join(" ")
    },
    r
  );
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...w,
      style: (d = o == null ? void 0 : o.style) == null ? void 0 : d.button,
      className: f.join(" "),
      disabled: t
    },
    s,
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...o,
      style: (t = l == null ? void 0 : l.style) == null ? void 0 : t.container,
      className: s.join(" ")
    },
    r
  );
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...o,
      style: (t = l == null ? void 0 : l.style) == null ? void 0 : t.divider,
      className: s.join(" ")
    }
  );
}, h1 = F({
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...o,
      style: (t = l == null ? void 0 : l.style) == null ? void 0 : t.input,
      className: s.join(" ")
    },
    r
  );
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...o,
      style: (t = l == null ? void 0 : l.style) == null ? void 0 : t.label,
      className: s.join(" ")
    },
    r
  );
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...o,
      style: (t = l == null ? void 0 : l.style) == null ? void 0 : t.message,
      className: s.join(" ")
    },
    r
  );
...
function K({
  ...
  var E;
  const [f, d] = h(""), [c, u] = h(""), [m, a] = h(""), [i, g] = h(!1), b = async (C) => {
    C.preventDefault(), u(""), a(""), g(!0);
    const { error: _ } = await l.auth.signInWithOtp({
      email: f,
      options: { emailRedirectTo: o }
    });
    _ ? u(_.message) : a("Check your email for the magic link"), g(!1);
  }, n = s == null ? void 0 : s.magic_link;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: b }, /* @__PURE__ */ e.createElement(L, { gap: "large", direction: "vertical", appearance: t }, /* @__PURE__ */ e.createElement(L, { gap: "large", direction: "vertical", appearance: t }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "email", appearance: t }, n == null ? void 0 : n.email_input_label), /* @__PURE__ */ e.createElement(
    H,
    {
      id: "email",
      name: "email",
    ...
    i ? n == null ? void 0 : n.loading_button_label : n == null ? void 0 : n.button_label
  )), w && /* @__PURE__ */ e.createElement(
    B,
    {
      href: "#auth-sign-in",
      onClick: (C) => {
        C.preventDefault(), r(p.SIGN_IN);
      },
      appearance: t
    },
    (E = s == null ? void 0 : s.sign_in) == null ? void 0 : E.link_text
  ), m && /* @__PURE__ */ e.createElement(z, { appearance: t }, m), c && /* @__PURE__ */ e.createElement(z, { color: "danger", appearance: t }, c)));
}
const x = F({
  width: "21px",
  height: "21px"
...
function D1({
  ...
  redirectTo: s,
  onlyThirdPartyProviders: t = !0,
  view: w = "sign_in",
  i18n: f,
  appearance: d
}) {
  const [c, u] = h(!1), [m, a] = h(""), i = l === "vertical", g = async (n) => {
    u(!0);
    const { error: E } = await r.auth.signInWithOAuth({
      provider: n,
      options: { redirectTo: s }
    });
    E && a(E.message), u(!1);
  };
  function b(n) {
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, o && o.length > 0 && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(L, { gap: "large", direction: "vertical", appearance: d }, /* @__PURE__ */ e.createElement(
    L,
    {
    ...
    o.map((n) => {
      ...
      return /* @__PURE__ */ e.createElement(
        ...
        i && r1((C = f == null ? void 0 : f[w]) == null ? void 0 : C.social_provider_text, {
          provider: b(n)
        })
      );
    })
  )), !t && /* @__PURE__ */ e.createElement(g1, { appearance: d })));
}
function q({
  authView: r = "sign_in",
  defaultEmail: l = "",
  ...
  var R, W, O, T;
  const i = s1(!0), [g, b] = h(l), [n, E] = h(o), [C, _] = h(""), [N, V] = h(!1), [S, M] = h("");
  U(() => (i.current = !0, b(l), E(o), () => {
    i.current = !1;
  }), [r]);
  const X = async (y) => {
    var G;
    switch (y.preventDefault(), _(""), V(!0), r) {
      case "sign_in":
      ...
      case "sign_up":
        ...
        j ? _(j.message) : e1 && !t1 && M(
          ((G = m == null ? void 0 : m.sign_up) == null ? void 0 : G.confirmation_text) || "Check your email for the confirmation link."
        );
        break;
    }
    i.current && V(!1);
  ...
  return /* @__PURE__ */ e.createElement(
    "form",
    {
      id: r === "sign_in" ? "auth-sign-in" : "auth-sign-up",
      onSubmit: X,
      autoComplete: "on",
      style: { width: "100%" }
    },
    /* @__PURE__ */ e.createElement(L, { direction: "vertical", gap: "large", appearance: a }, /* @__PURE__ */ e.createElement(L, { direction: "vertical", gap: "large", appearance: a }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "email", appearance: a }, v == null ? void 0 : v.email_label), /* @__PURE__ */ e.createElement(
      H,
      {
        id: "email",
        type: "email",
    ...
    )), /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "password", appearance: a }, v == null ? void 0 : v.password_label), /* @__PURE__ */ e.createElement(
      H,
      {
        id: "password",
        type: "password",
        ...
        autoComplete: r === "sign_in" ? "current-password" : "new-password",
        appearance: a
      }
    ))), /* @__PURE__ */ e.createElement(
      $,
      ...
      N ? v == null ? void 0 : v.loading_button_label : v == null ? void 0 : v.button_label
    ), d && /* @__PURE__ */ e.createElement(L, { direction: "vertical", gap: "small", appearance: a }, r === p.SIGN_IN && u && /* @__PURE__ */ e.createElement(
      B,
      {
        href: "#auth-magic-link",
        onClick: (y) => {
          y.preventDefault(), s(p.MAGIC_LINK);
        },
        appearance: a
      },
      (R = m == null ? void 0 : m.magic_link) == null ? void 0 : R.link_text
    ), r === p.SIGN_IN && /* @__PURE__ */ e.createElement(
      B,
      {
        href: "#auth-forgot-password",
        onClick: (y) => {
          y.preventDefault(), s(p.FORGOTTEN_PASSWORD);
        },
        appearance: a
      },
    ...
    S && /* @__PURE__ */ e.createElement(z, { appearance: a }, S),
    C && /* @__PURE__ */ e.createElement(z, { color: "danger", appearance: a }, C)
  );
}
function Y({
  setAuthView: r = () => {
  ...
  const [f, d] = h(""), [c, u] = h(""), [m, a] = h(""), [i, g] = h(!1), b = async (C) => {
    C.preventDefault(), u(""), a(""), g(!0);
    const { error: _ } = await l.auth.resetPasswordForEmail(f, {
      redirectTo: o
    });
    _ ? u(_.message) : a("Check your email for the password reset link"), g(!1);
  }, n = s == null ? void 0 : s.forgotten_password;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-forgot-password", onSubmit: b }, /* @__PURE__ */ e.createElement(L, { gap: "large", direction: "vertical", appearance: t }, /* @__PURE__ */ e.createElement(L, { gap: "large", direction: "vertical", appearance: t }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "email", appearance: t }, n == null ? void 0 : n.email_label), /* @__PURE__ */ e.createElement(
    H,
    {
      id: "email",
      name: "email",
...
function J({
  ...
  const [s, t] = h(""), [w, f] = h(""), [d, c] = h(""), [u, m] = h(!1), a = async (g) => {
    g.preventDefault(), f(""), c(""), m(!0);
    const { error: b } = await r.auth.updateUser({ password: s });
    b ? f(b.message) : c("Your password has been updated"), m(!1);
  }, i = l == null ? void 0 : l.update_password;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-update-password", onSubmit: a }, /* @__PURE__ */ e.createElement(L, { gap: "large", direction: "vertical", appearance: o }, /* @__PURE__ */ e.createElement(L, { gap: "large", direction: "vertical", appearance: o }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(D, { htmlFor: "password", appearance: o }, i == null ? void 0 : i.password_label), /* @__PURE__ */ e.createElement(
    H,
    {
      id: "password",
      name: "password",
      placeholder: i == null ? void 0 : i.password_label,
      type: "password",
      autoFocus: !0,
    ...
    u ? i == null ? void 0 : i.loading_button_label : i == null ? void 0 : i.button_label
  )), d && /* @__PURE__ */ e.createElement(z, { appearance: o }, d), w && /* @__PURE__ */ e.createElement(z, { color: "danger", appearance: o }, w)));
}
const Q = c1({ user: null, session: null }), $1 = (r) => {
  const { supabaseClient: l } = r, [o, s] = h(null), [t, w] = h((o == null ? void 0 : o.user) ?? null);
  U(() => {
    (async () => {
      var u;
      const { data: c } = await l.auth.getSession();
      s(c.session), w(((u = c.session) == null ? void 0 : u.user) ?? null);
    })();
    const { data: d } = l.auth.onAuthStateChange(
      async (c, u) => {
        s(u), w((u == null ? void 0 : u.user) ?? null);
      }
    );
    return () => {
  ...
  return /* @__PURE__ */ e.createElement(Q.Provider, { value: f, ...r });
}, I1 = () => {
  const r = i1(Q);
  if (r === void 0)
...
function I({
  ...
  const a = A(n1, m.variables ?? {}), [i, g] = h(s), [b, n] = h(""), [E, C] = h(""), _ = i === "sign_in" || i === "sign_up";
  U(() => {
    var S, M;
    l1({
      theme: A(
        ((S = c == null ? void 0 : c.theme) == null ? void 0 : S.default) ?? {},
        ((M = c == null ? void 0 : c.variables) == null ? void 0 : M.default) ?? {}
      )
    });
  }, [c]);
  const N = ({ children: S }) => {
        ...
        "div",
        {
          className: u !== "default" ? o1(
            A(
              ...
              ((M = c == null ? void 0 : c.variables) == null ? void 0 : M[u]) ?? {}
            )
          ) : ""
        },
  ...
  U(() => {
    const { data: S } = r.auth.onAuthStateChange(
      (M) => {
        M === "PASSWORD_RECOVERY" ? g("update_password") : M === "USER_UPDATED" && g("sign_in");
      }
    );
    return g(s), () => S.subscription.unsubscribe();
  }, [s]);
  const V = {
    supabaseClient: r,
    setAuthView: g,
  ...
  switch (i) {
    case p.SIGN_IN:
      return /* @__PURE__ */ e.createElement(N, null, /* @__PURE__ */ e.createElement(q, { ...V, authView: "sign_in" }));
    case p.SIGN_UP:
